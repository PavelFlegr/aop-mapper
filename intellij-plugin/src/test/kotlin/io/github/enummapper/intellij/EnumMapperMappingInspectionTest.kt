...
class EnumMapperMappingInspectionTest : BasePlatformTestCase() {
    override fun setUp() {
        super.setUp()
        myFixture.enableInspections(EnumMapperMappingInspection())
        myFixture.addFileToProject(
            ...
            public object EnumMapper {
                public fun <D : Enum<D>> map(source: Enum<*>, destination: Class<D>): D =
                    error("test")
            }
    ...
    fun testReportsDirectEnumMapperCall() {
        val errors = highlight(
            """
            package example
    ...
    fun testAcceptsPropertyOverride() {
        val errors = highlight(
            """
            package example
            import io.github.enummapper.from
            import io.github.enummapper.mapper
