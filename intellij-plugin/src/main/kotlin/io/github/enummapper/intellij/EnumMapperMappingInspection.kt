...
package io.github.enummapper.intellij
...
public class EnumMapperMappingInspection : LocalInspectionTool() {
    ...
    private fun validate(expression: KtCallExpression): String? {
        ...
        return when (callableName) {
            ...
            JAVA_MAP -> {
                val source = expression.valueArguments.firstOrNull()
                    ?.getArgumentExpression()
                    ?.expressionType
                validateEnumMapping(source, expression.expressionType)
            }
    ...
    private companion object {
        const val MAP_TO = "io.github.enummapper.mapTo"
        const val JAVA_MAP = "io.github.enummapper.EnumMapper.map"
        const val OBJECT_MAPPER = "io.github.enummapper.mapper"
